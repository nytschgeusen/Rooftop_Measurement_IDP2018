...
def makeFig(): #Create a function that makes our desired plot
    ...
    plt2.set_ylabel('Humidity (h)')                    #label second y axis
...
while True: # While loop that loops forever
    ...
    hum =    float( dataArray[1])            #Convert second element to floating number and put in H
    t.append(temp)                     #Build our tempF array by appending temp readings
    h.append(hum)                     #Building our pressure array by appending P readings
